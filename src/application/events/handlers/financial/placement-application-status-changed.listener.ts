...
import { HandlesEvent, JobApplicationStatusChangedEvent } from "@application/events";
...
export class PlacementApplicationStatusChangedListener {
  ...
  @HandlesEvent(JobApplicationStatusChangedEvent.eventType, PlacementApplicationStatusChangedListener.name)
