...
import { HandlesEvent, MentorAppealApprovedEvent } from "@application/events";
...
export class AppealApprovedListener {
   ...
   */
  @OnEvent(MentorAppealApprovedEvent.eventType)
  @HandlesEvent(MentorAppealApprovedEvent.eventType, AppealApprovedListener.name)
  async handleAppealApproved(event: MentorAppealApprovedEvent): Promise<void> {
