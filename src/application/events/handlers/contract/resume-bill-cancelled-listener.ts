...
import { HandlesEvent, ResumeBillCancelledEvent } from "@application/events";
...
export class ResumeBillCancelledListener extends ContractEventListenerBase {
   ...
   */
  @OnEvent(ResumeBillCancelledEvent.eventType)
  @HandlesEvent(ResumeBillCancelledEvent.eventType, ResumeBillCancelledListener.name)
  async handleResumeBillCancelledEvent(
    event: ResumeBillCancelledEvent,
  ): Promise<void> {
    try {
