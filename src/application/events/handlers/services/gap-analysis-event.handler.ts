 ...
 * 
 * Handles async meeting creation flow triggered by GapAnalysisService.createSession()
 * 
 * Responsibilities:
 * 1. Listen to GAP_ANALYSIS_SESSION_CREATED_EVENT
...
export class GapAnalysisCreatedEventHandler {
  ...
  @HandlesEvent(GapAnalysisSessionCreatedEvent.eventType, GapAnalysisCreatedEventHandler.name)
