...
@Injectable()
export class GetStudentRegularMentoringSessionsUseCase {
  constructor(
  ...
  async execute(studentId: string, filters?: RegularMentoringQueryDto): Promise<RegularMentoringReadModel[]> {
    return this.regularMentoringQueryRepository.getStudentSessions(studentId, filters);
  }
}
