...
import { SettlementConfirmedListener } from "./settlement-confirmed.listener";
...
import type { ISettlementConfirmedEvent } from "@shared/events/settlement-confirmed.event";
...
describe("SettlementConfirmedListener", () => {
  ...
  describe("handleSettlementConfirmed", () => {
    const validEvent: ISettlementConfirmedEvent = {
