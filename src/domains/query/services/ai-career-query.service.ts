...
import { AiCareerSessionEntity } from '@domains/services/sessions/ai-career/entities/ai-career-session.entity';
 ...
 * Handles read operations for AI career sessions with joins across domains
 * Joins: ai_career_sessions + meetings + user (for mentor/student names)
 */
@Injectable()
export class AiCareerQueryService {
   ...
   */
  private async enrichSessionsWithUserNames(sessions: AiCareerSessionEntity[]): Promise<any[]> {
