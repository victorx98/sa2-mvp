...
export interface ICreateJobPositionDto {
  ...
  requirements?: Record<string, unknown> | string[]; // Job requirements [岗位要求]
  ...
  locations?: Array<Record<string, unknown>>; // Location list [地点列表]
  ...
  aiAnalysis?: Record<string, unknown>; // AI analysis results [AI分析结果]
