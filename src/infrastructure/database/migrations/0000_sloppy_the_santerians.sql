...
CREATE TYPE "public"."entitlement_revision_type" AS ENUM('initial', 'addon', 'promotion', 'compensation', 'increase', 'decrease', 'expiration', 'termination');--> statement-breakpoint
CREATE TYPE "public"."revision_status" AS ENUM('pending', 'approved', 'rejected', 'applied');--> statement-breakpoint
...
CREATE TYPE "public"."service_ledger_source" AS ENUM('booking_completed', 'booking_cancelled', 'contract_signed', 'manual_adjustment', 'auto_expiration');--> statement-breakpoint
CREATE TYPE "public"."service_ledger_type" AS ENUM('consumption', 'refund', 'adjustment', 'initial', 'expiration');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "contract_entitlement_revisions" ADD CONSTRAINT "contract_entitlement_revisions_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contract_entitlement_revisions" ADD CONSTRAINT "contract_entitlement_revisions_entitlement_id_contract_service_entitlements_id_fk" FOREIGN KEY ("entitlement_id") REFERENCES "public"."contract_service_entitlements"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contract_entitlement_revisions" ADD CONSTRAINT "contract_entitlement_revisions_approved_by_user_id_fk" FOREIGN KEY ("approved_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contract_entitlement_revisions" ADD CONSTRAINT "contract_entitlement_revisions_created_by_user_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "contract_service_entitlements" ADD CONSTRAINT "contract_service_entitlements_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_holds" ADD CONSTRAINT "service_holds_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "service_ledgers" ADD CONSTRAINT "service_ledgers_contract_id_contracts_id_fk" FOREIGN KEY ("contract_id") REFERENCES "public"."contracts"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
